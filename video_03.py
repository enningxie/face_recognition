# from vote_03 用于处理ck的视频,不用框只显示名字
...
input_movie = cv2.VideoCapture("/home/enningxie/Desktop/stu.avi")
# input_movie_ = input_movie.open("/home/enningxie/Desktop/stu.avi")
length = int(input_movie.get(cv2.CAP_PROP_FRAME_COUNT))

# Create an output movie file (make sure resolution/frame rate matches input video!)
# fourcc = cv2.VideoWriter_fourcc(*'I420')
output_movie = cv2.VideoWriter('/home/enningxie/Desktop/output16.avi', cv2.VideoWriter_fourcc('I', '4', '2', '0'), 25, (4096, 2160))
